...
nameOfFile = input("Enter nameOfFile: ")

# Infinite loop to create code
while True:
    regionName = input("Enter regionName (type '.' to finish): ")
    if not generate_code(nameOfFile, regionName):
        break
